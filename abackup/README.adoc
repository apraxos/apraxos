...
- beides - Inkrementelle Sicherung und rollierende Sicherung anbieten
...
- Inkrementelle Sicherung auf lokaler Festplatte/USB Festplatte mittels rsync --link-dest
- Inkrementelle Sicherung auf NAS: Nutzung von Snapshots
