...
* backup.cfg.remotesource: ein Beispiel, welches die Daten eines entfernten Rechners lokal auf die Festplatte sichert. Dies ist z.B. nützlich um weitere Arbeitsplatzrechner am Apraxos Server zu sichern.
